...
Ding and Peng proposed Maximum Redundancy Maximum Relevance (MRMR) \cite{ding2005minimum} as a feature selection method for gene microarray data. 
...
% 2. Why NB and KNN do not work well? Why DT overfit the data (you use full size)? RF is better because of the ensemble mechanism? Too many features too few instances? 

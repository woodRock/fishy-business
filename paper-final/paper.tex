...
(1) Variations of MRMR are propsoed in Uber paper \cite{zhao2019maximum}, these use differnet relevance and redunacy metrics. 
...
Stripped of its labels, this could be employed for S3VM described in (2), or alternatively, pre-training/transfer learning aproaches. 
This would require significant pre-processing for consistent representation across datasets. 

...
\begin{abstract}
  ...
  Efficient use of fish biomas aided by real-world AI can help preserve fish for future generations to come.
...
% TODO [x]  Try to state the current techniques for this problem and the key lmiations of them, which will form the movitation for this work.
...
% TODO [x] - provide a description of anaylsis on why LSVM performed/generalized much better than SVC and NuSVC. 
...
The SVC and Nu-SVC models both default to an RBF kernal. 

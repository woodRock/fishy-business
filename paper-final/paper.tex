...
% TODO [x] - Introduce fish oil analysis: what it is, why it is important. 
% TODO [x] - Narrowing down to fish classification is an essential step: fish types, fish parts. 
% TODO [x] - Existing limitations of fish classification: manually, labour intensive. 
% TODO [x] - How machine learning can be used to address the above limitations. 
...
Previous work on gas chromatography \cite{bi2020gc,matyushin2020gas}, has shown machine learning can be used to automate classification. 
...
\begin{enumerate}
  \item Chromatography methods: how the raw fish oil data is collected.
...
Two heuristics are optimized when selecting a suitable model:
...
The classification results (\S~\ref{sec:results-classification}) support this, they also show higher test accuracy for fish species, than for fish parts.

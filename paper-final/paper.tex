...
% TODO [ ] - DIscuss visualisation (interpretability) and the need for feature selection. 
...
% TODO [ ] - Figure is too small, figure not referenced in text, needs to be referred to. 
...
% It is also a good motivation for feature selection.
...
% TODO [ ] - Briefly explain why FS here? 
% TODO [ ] - Briefly describe each method, and why they are used/ 
...
% TODO [ ] - I don't think it is necessary to discuss k = 500 
% i.e. The following subsections provides all the information. you can remove this part and focus more on the following subsection.
...
% 3. You can have 2 different graphs for fish species and part. 

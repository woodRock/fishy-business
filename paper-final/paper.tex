...
% TODO [ ] - Edit and clean up what is below. 
% TODO [ ] - Related work, contributions, real-world applications. 
...
% i.e. dimensionality, inefficiency, low interpretability, complext models. 
...
\begin{equation}
  f^{mRMR} = I(Y,X_i) - \frac{1}{|S|} \sum_{X_s \in S} I(X_s;X_i) \label{eq:mrmr}
\end{equation}  
...
Robnik proposed ReliefF \cite{kononenko1994estimating}, this extends the original Relief \cite{kira1992practical} to be noise-tolerant, handle missing values and multi-class.
...
The model is noise tolerant by averaging the contribution of the $k$ nearest neighbours. 
Missing values of attributes are treated probabilistically \cite{robnik2003theoretical}.
Given an instance $I$, a near hit is a neighbour of same class $class(I)$, a near miss is a neighbour of different class $\neg class(I)$. 
It handles multi-class problems by taking the weighted average of near misses to all classes.

% TODO [ ] - Description of ReliefF 

...
% TODO [x] - The figure is too small, 
% TODO [x] - a figure not referenced in the text, needs to be referred to. 
...
\\\\
% TODO [ ] - Flesh out these representations, or use consistent variables for all, to facilitate easy comparison. 
...
% TODO [ ] - Provide a short description for each algorithm here! What are their parameter settings? 
...
Central Limit Theorem says a sample distribution will approach a normal distribution $\mathcal{N}(\mu,\sigma)$, a sample size of 30 approximates a realiable measure of variance with respect to the population. 
...
The mean, and standard deviation of balanced accury is given using for the fish species and part datasets. 
For each dataset, the best test accuracy is empahized in bold. 
...
% TODO [ ] - This part can be shortened, and, 
% TODO [x] - included in the visualisation sections, (not background)
...
% TODO [ ] - This part can be removed, and a brief description can be provided when SVM is used. 
...
% 1. PSO achieves the best training accuracies with a much smaller number fo features. 
% 2. Testing accuracy of PSO is not that good, potential overfitting, future work. 
% 3. Other algorithms also achieve the best performance at around 1050 features, FS is helpful to improve the part classification. 

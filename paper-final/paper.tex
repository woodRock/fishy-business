...
Worldwide, 60\% of treated fish biomass is discarded \cite{galanakis2019saving}, an incredible waste of the Earth's limited resources. 
Instead, fish biomass can be repurposed for fish oils such as Omega 3 vitamin supplements, or fish meal for use in animal feeds. 
...
% TODO [ ] - The description of SVMs can be shorted to save space. 
...
The default mode uses the RBF kernel.
Other models use different kernels and parameters \cite{sklearn2021feature}.
Some models remove trainable parameters.
Instead, the user can set \emph{Nu} which determines the number of support vectors \cite{scholkopf2000new}.

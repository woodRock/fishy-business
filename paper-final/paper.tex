...
\begin{figure}[htb]
  ...
  \caption{
    ...
    The detection is used to visualize intensity (y axis) and time (x axis) on a chromotrogaph. The distinguishable peaks are unique signatures where a chemical compound can likely to be identified.}
...
Kennedy and Eberhart proposed a discrete PSO \cite{kennedy1997discrete}, a swarm intelligence method with discrete for feature selection. 

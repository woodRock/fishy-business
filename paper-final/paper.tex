...
\begin{itemize}
  \item Talk about the normalization constant in MRMR and ReliefF, make noise-tolerant
  ...
  \item Compare $\chi^2$ threshold to reliefF $m$, both found automatically by algorithm. 
  \item 
\end{itemize}

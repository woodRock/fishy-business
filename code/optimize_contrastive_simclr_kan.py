...
def objective(trial: optuna.Trial) -> float:
    ...
    num_layers = trial.suggest_int("num_layers", 1, 5) # KAN specific
    num_inner_functions = trial.suggest_categorical("num_inner_functions", [5, 10, 15]) # KAN specific
    ...
    config = ContrastiveConfig(
        encoder_type="kan", # Optimizing for KAN
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(direction="minimize", study_name="contrastive_simclr_kan_optimization")
    ...
    # import joblib
    # joblib.dump(study, "contrastive_simclr_kan_optuna_study.pkl")

...
def objective(trial: optuna.Trial) -> float:
    ...
    config = ContrastiveConfig(
        encoder_type="rcnn", # Optimizing for RCNN
        ...
        patience=100,
        weight_decay=1e-6,
        num_heads=8, # Not used by RCNN
        num_layers=6, # Not directly used by RCNN, but required by ContrastiveConfig
    )
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(direction="minimize", study_name="contrastive_simclr_rcnn_optimization")
    ...
    # import joblib
    # joblib.dump(study, "contrastive_simclr_rcnn_optuna_study.pkl")
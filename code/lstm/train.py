...
, 
    ...
    Args: 
        model (LSTM): the LSTM model to evaluate training performance for.
    ...
    for inputs, targets in dataloader:
        ...
        optimizer.zero_grad()
        outputs = model(inputs)  # Assuming no masking is needed for now
...
def transfer_learning(
    ...
    Args":
        ...
        model (LSTM): the LSTM model to transfer the weights to.

...
from contrastive.util import DataConfig, DataPreprocessor, SiameseDataset, BalancedBatchSampler
...
def main(encoder_type, contrastive_method, model_path):
    ...
    visualize_batch_thresholds(
        ...
        os.path.join(output_dir, f"{contrastive_method}_{encoder_type}_train_embeddings.png"),
        best_threshold,
    )
    ...
    visualize_batch_thresholds(
        ...
        os.path.join(output_dir, f"{contrastive_method}_{encoder_type}_val_embeddings.png"),
        best_threshold,
    )
    ...
    visualize_batch_thresholds(
        ...
        os.path.join(output_dir, f"{contrastive_method}_{encoder_type}_test_embeddings.png"),
        best_threshold,
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Visualize learned embeddings from a contrastive model.")
    parser.add_argument("--encoder_type", type=str, default="cnn", help="Encoder architecture to use.")
    parser.add_argument("--contrastive_method", type=str, default="simclr", help="Contrastive learning method used.")
    parser.add_argument("--model_path", type=str, default="best_model_simclr_cnn_overall.pth", help="Path to the trained model weights.")

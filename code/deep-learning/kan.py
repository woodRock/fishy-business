...
class KAN(nn.Module):
    def __init__(self, 
        ...
        self.layers = nn.ModuleList([KANLayer(input_dim, output_dim if i == (num_layers - 1) else input_dim, hidden_dim, num_inner_functions, dropout_rate) for i in range(num_layers)])

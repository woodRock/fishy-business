...
def sequential_transfer_learning(
    ...
    plt.title(f'Confusion Matrix - {target_dataset} (Balanced Acc: {final_balanced_accuracy*100:.2f}%)')
...
def visualize_transfer_learning_performance(history):
    ...
    for dataset in history['transfer']:
        ...
        final_balanced_accuracies.append(history['transfer'][dataset]['val_balanced_acc'][-1])
    
    for dataset in history['finetune']:
        final_accuracies.append(history['finetune'][dataset]['val_acc'][-1])
        final_balanced_accuracies.append(history['finetune'][dataset]['val_balanced_acc'][-1])

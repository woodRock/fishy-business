...
from deep_learning.main import TrainingConfig, ModelTrainer, create_model, MODEL_REGISTRY
...
class TestDeepLearning(unittest.TestCase):
    ...
    @patch('deep_learning.main.ModelTrainer._setup_logging')
    def test_pre_train(self, mock_setup_logging, mock_pre_trainer, mock_create_data_module):
        ...
        mock_pre_trainer_instance.pre_train_masked_spectra.return_value = MagicMock(spec=nn.Module)

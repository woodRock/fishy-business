...
def objective(trial: optuna.Trial) -> float:
    ...
    num_layers = trial.suggest_int("num_layers", 2, 6) # For encoder layers
    ...
    config = ContrastiveConfig(
        encoder_type="cnn", # Optimizing for CNN
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(direction="minimize", study_name="contrastive_simclr_cnn_optimization")
    ...
    # import joblib
    # joblib.dump(study, "contrastive_simclr_cnn_optuna_study.pkl")

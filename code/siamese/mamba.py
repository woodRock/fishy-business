...
class MambaEncoder(nn.Module):
    def __init__(self, input_dim, d_model, d_state, num_layers, dropout=0.1):
        super().__init__()
...
class ContrastiveModel(nn.Module):
    def __init__(self, input_dim, d_model, d_state, num_layers, num_classes, dropout=0.1):
        super().__init__()
        self.encoder = MambaEncoder(input_dim, d_model, d_state, num_layers, dropout)
...
def main():
    ...
    model = ContrastiveModel(input_dim, d_model, d_state, num_layers, num_classes, dropout).to(device)

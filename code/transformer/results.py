...
if __name__ == "__main__":
    ...
    for i in range(1,10+1):
        ...
        with open(file_path) as f:
            ...
            # The training accuracy is on line 342.
            train_acc: float = float(content[342].split(sep=' ')[-1])
            # The validation accuracy is on line 244.
            val_acc: float = float(content[344].split(sep=' ')[-1])
            # The test accuracy is on line 346.
            test_acc: float = float(content[346].split(sep=' ')[-1])

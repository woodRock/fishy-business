...
def setup_parser() -> argparse.ArgumentParser:
    ...
    hp_group.add_argument(
        ...
        "--random-projection",
        action="store_true",
        help="Apply random projection to the input data (QJL-style)",
    )
    hp_group.add_argument(
        "-q",
        "--quantize",
        action="store_true",
        help="Apply QJL/TurboQuant quantization (sign-bit) after random projection",
    )
    hp_group.add_argument(
        "-T",
        "--turbo-quant",
        action="store_true",
        help="Apply Two-Stage TurboQuant (Residual-based QJL)",
    )
    hp_group.add_argument(
        "--polar",
        action="store_true",
    ...
    hp_group.add_argument(
        ...
        type=str,
        default=None,
        choices=["hadamard", "outer_product", "complex", "multiplicative", "additive"],
    )
    hp_group.add_argument(
    ...
    hp_group.add_argument(
        ...
        action="store_true",
        dest="use_qk_gain",
        help="Use learnable QK-gain in AugFormerV2",
    )
    hp_group.add_argument(
        "--parallel-residuals",
        action="store_true",
        dest="use_parallel_residuals",
        help="Use parallel residuals in AugFormerV2",
    )
    hp_group.add_argument(
        "--recurrence",
        type=int,
        nargs="+",
        dest="recurrence_layers",
        help="Indices of layers to recur in AugFormerV2",
    )
    hp_group.add_argument(
        "--leaky-sq",
        action="store_true",
    ...
    hp_group.add_argument(
        ...
        action="store_true",
        dest="use_ttt",
        help="Use Test-Time Training (TTT) in AugFormerV2",
    )
    hp_group.add_argument(

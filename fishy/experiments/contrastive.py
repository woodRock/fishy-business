...
class ContrastiveTrainer:
    ...
    def __init__(
        self, config: ContrastiveConfig, wandb_run: Optional[Any] = None
    ) -> None:
        """
    ...
    def train(self) -> None:
        ...
        self.ctx.save_results(
            {
                "history": history,
                "stats": {"final_contrastive_loss": history["loss"][-1]},
            },
...
def run_contrastive_experiment(
    config: ContrastiveConfig, wandb_run: Optional[Any] = None
) -> None:
    """

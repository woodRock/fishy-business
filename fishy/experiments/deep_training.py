...
class ModelTrainer:
    ...
    def _train_single_split_siamese(self, pre_trained_model: Optional[nn.Module]) -> Dict[str, Any]:
        ...
        final_metrics = {"train_loss": tr_val_met.get("train_loss"), "val_loss": tr_val_met.get("val_loss"), "test_loss": test_res.get("loss"), "test_balanced_accuracy": test_res.get("metrics", {}).get("balanced_accuracy")}

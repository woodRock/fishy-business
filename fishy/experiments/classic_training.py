...
class ClassicTrainer:
    ...
    def __init__(
        self, model_name: str, dataset_name: str, run_id: int = 0, file_path: str = None
    ):
        ...
        self.ctx = RunContext(
            experiment_name=f"classic_{self.model_name}_{dataset_name}", run_id=run_id
        )
...
def run_classic_experiment(
    model_name: str, dataset_name: str, run_id: int = 0, file_path: str = None
):

...
def load_dataset(dataset: str = "species", file_path: str = None) -> Union[Iterable, Iterable]:
    ...
    if dataset == "species":
                ...
                if "Fillet" in x
                    ...
                    if "Heads" in x
                        ...
                        if "Livers" in x
                            ...
                            3
                            if "Skins" in x
                            else (4 if "Guts" in x else (5 if "Frames" in x else None))
                        )
                    )
                )
            )
                        ...
                        if "MO 10" in x
                            ...
                            if "MO 05" in x
                                ...
                                if "MO 01" in x
                                    ...
                                    5 if "MO 0.1" in x else (6 if "MO 0" in x else None)
                                )
                            )
                        )
                    )
        ...
        data = data[
            ...
            .astype(str)
            .str.contains(
                "QC|MO|fillet|frames|gonads|livers|skins|guts|frame|heads",
                case=False,
                na=False,
            )
        ]

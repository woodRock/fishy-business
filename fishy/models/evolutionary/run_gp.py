...
from .gp_data import load_dataset
from .gp_plot import plot_tsne, plot_gp_tree
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        "--file-path",
        type=str,
        default="../../../outputs/checkpoints/embedded-gp.pth",
        help="The filepath to store the checkpoints. Defaults to ../../../outputs/checkpoints/embedded-gp.pth",
    )
    parser.add_argument(
        "-d",
        "--dataset",
    ...
    parser.add_argument(
        ...
        "--output",
        type=str,
        default=f"../../../outputs/logs/classifiers_gp/results",
        help="Partial filepath for the output logging. Defaults to '../../../outputs/logs/classifiers_gp/results'.",
    )
    parser.add_argument(
        "-p",
        "--population",
